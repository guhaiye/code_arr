...
function Youa (obj)
{
	...
	this.timer = null;
	this.oData = [
		{left:0, zIndex:2, opacity:100},
		{left:700, zIndex:3,opacity:100},
		{left:1420, zIndex:4, opacity:100},
		{left:208, zIndex:3, opacity:100},
		{left:246, zIndex:2, opacity:100},
		{left:40, zIndex:0, opacity:100}
	];
	this.__create__()
...
Youa.prototype.__create__ = function ()
{
	...
	/*jQuery('#control').find('span')[1].hover(function(){
		alert("im here");
	});*/
...
Youa.prototype.__set__ = function ()
{
	...
	jQuery("#container").find("img").removeClass('current');
	jQuery("#container").find("div").eq(2).find("img").addClass('current');
